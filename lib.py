...
class Client():
    ...
    def getBet(self, status, pair, amount="1", duration="60"):
        ...
        ws.send('[{"t":2,"e":23,"uuid":"'+self.generateUuid()+'","d":[{"amount":'+amount+',"dir":"'+status+'","pair":"'+pair+'","cat":"'+self.locked[pair]+'","pos":0,"source":"platform","account_id":'+self.accountId+',"group":"'+self.accountGroup+'","timestamp":'+str(int(time.time()))+',"risk_free_id":null,"duration":'+duration+'}]}]')
